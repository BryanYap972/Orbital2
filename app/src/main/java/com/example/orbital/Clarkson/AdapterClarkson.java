...
public class AdapterClarkson extends RecyclerView.Adapter<AdapterClarkson.MyHolder> {
    ...
    public AdapterClarkson(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewClarkson.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("Clarkson").orderByChild("pId").equalTo(pId);
