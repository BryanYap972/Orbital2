...
public class AdapterBilkent extends RecyclerView.Adapter<AdapterBilkent.MyHolder> {
    ...
    public AdapterBilkent(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewBilkent.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("Bilkent").orderByChild("pId").equalTo(pId);
