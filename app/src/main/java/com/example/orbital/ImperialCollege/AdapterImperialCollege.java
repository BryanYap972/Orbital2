...
public class AdapterImperialCollege extends RecyclerView.Adapter<AdapterImperialCollege.MyHolder> {
    ...
    public AdapterImperialCollege(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewImperialCollege.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("ImperialCollege").orderByChild("pId").equalTo(pId);
