...
public class BostonUActivity extends AppCompatActivity {

    FirebaseAuth firebaseAuth;

    RecyclerView recyclerView;
    List<ModelReviews> reviewsList;
    AdapterBostonU adapterReviews;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boston_u);
        actionBar = getSupportActionBar();
        actionBar.setTitle("Boston University");

        firebaseAuth = FirebaseAuth.getInstance();

        recyclerView = this.findViewById(R.id.bostonURecyclerView);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    adapterReviews = new AdapterBostonU(getApplicationContext(), reviewsList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_add_post) {
            startActivity(new Intent(this, AddReviewBostonU.class));
        }
