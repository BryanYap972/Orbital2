...
public class AdapterBostonU extends RecyclerView.Adapter<AdapterBostonU.MyHolder> {
    ...
    public AdapterBostonU(Context context, List<ModelReviews> reviewsList) {
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("BostonU").orderByChild("pId").equalTo(pId);
