...
public class AdapterDurham extends RecyclerView.Adapter<AdapterDurham.MyHolder> {
    ...
    public AdapterDurham(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewDurham.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("Durham").orderByChild("pId").equalTo(pId);
