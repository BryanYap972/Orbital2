...
public class AdapterCarleton extends RecyclerView.Adapter<AdapterCarleton.MyHolder> {
    ...
    public AdapterCarleton(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewCarleton.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("Carleton").orderByChild("pId").equalTo(pId);
