...
public class AdapterChongqing extends RecyclerView.Adapter<AdapterChongqing.MyHolder> {
    ...
    public AdapterChongqing(Context context, List<ModelReviews> reviewsList) {
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if (id == 0) {
                        ...
                        Intent intent = new Intent(context, AddReviewChongqing.class);
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("Chongqing").orderByChild("pId").equalTo(pId);
