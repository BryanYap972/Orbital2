...
public class AlbertLudwigActivity extends AppCompatActivity {

    FirebaseAuth firebaseAuth;

    RecyclerView recyclerView;
    List<ModelReviews> reviewsList;
    AdapterAlbertLudwig adapterReviews;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_albert_ludwig);
        actionBar = getSupportActionBar();
        actionBar.setTitle("Albert-Ludwig University of Freiburg");

        firebaseAuth = FirebaseAuth.getInstance();
        fUser = FirebaseAuth.getInstance().getCurrentUser();
        myUid = fUser.getUid();

        recyclerView = this.findViewById(R.id.albertLudwigRecyclerView);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    adapterReviews = new AdapterAlbertLudwig(getApplicationContext(), reviewsList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_add_post) {
            startActivity(new Intent(this, AddReviewAlbertLudwig.class));
        }
