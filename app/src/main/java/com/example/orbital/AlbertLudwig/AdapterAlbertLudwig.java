...
public class AdapterAlbertLudwig extends RecyclerView.Adapter<AdapterAlbertLudwig.MyHolder>{
    ...
    public AdapterAlbertLudwig(Context context, List<ModelReviews> reviewsList) {
    ...
    @NonNull
    @Override
    public AdapterAlbertLudwig.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterAlbertLudwig.MyHolder myHolder, int i) {
    ...
    private void beginDelete(String pId) {
        ...
        Query fquery = FirebaseDatabase.getInstance().getReference("AlbertLudwig").orderByChild("pId").equalTo(pId);
