...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Add New Request");
        ...
        if (isUpdateKey.equals("editPost")) {
            actionBar.setTitle("Edit Request");
    ...
    private void uploadData(final String title, final String description) {
        pd.setMessage("Uploading request");
        pd.show();
        ...
        Drawable drawable = res.getDrawable(R.drawable.upload);
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(AddPostActivity.this, "Request uploaded", Toast.LENGTH_SHORT).show();
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted && storageAccepted) {
                        ...
                        Toast.makeText(this, "Camera and storage permissions are required to proceed", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
