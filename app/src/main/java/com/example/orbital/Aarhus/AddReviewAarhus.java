...
public class AddReviewAarhus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_review_aarhus);
    ...
    private void uploadData(final String title, final String description) {
        ...
        final String timeStamp = String.valueOf(System.currentTimeMillis());
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Aarhus");
            ref.child(timeStamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            pd.dismiss();
                            Toast.makeText(AddReviewAarhus.this, "Review uploaded", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(AddReviewAarhus.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }

    private void loadReviewData(String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Aarhus");
    ...
    private void updateReview(String title, String description, String editPostId) {
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddReviewAarhus.this, "Updated", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
